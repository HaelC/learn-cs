...
const CMU = ({ data }) => {
  ...
  return (
    <Layout>
      ...
      <h2>Courses</h2>
      <p>
        <a href="https://enr-apps.as.cmu.edu/open/SOC/SOCServlet/search">
          Here
        </a>{" "}
      ...
      <ul>
        ...
        <li>
          <a href="https://scs.hosted.panopto.com/Panopto/Pages/Sessions/List.aspx#folderID=%22618ea253-ca45-4b14-9f1d-aab501543bd2%22">
            Fall 2019: 15-388 Practical Data Science (Public)
          </a>
        </li>
        <li>
          <a href="https://scs.hosted.panopto.com/Panopto/Pages/Sessions/List.aspx#folderID=%2252a75ce9-84c7-4c75-8e16-a93b0120d253%22">
